...
Promise vs callback based
  ...
  - `require('bitcoind-rpc-finite/promise')` to have promises returned
  - `require('bitcoind-rpc-finite')` to have callback functions returned
...
Promise based:
```javascript
var RpcClient = require('bitcoind-rpc-finite/promise');
